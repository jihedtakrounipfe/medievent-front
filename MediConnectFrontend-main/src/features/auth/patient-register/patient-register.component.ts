  ...
  template: `
    <div class="w-full">
      ...
      <form [formGroup]="form" (ngSubmit)="onSubmit()" novalidate class="space-y-4">
        ...
        <!-- Optional fields -->
        <details class="group">
          <summary class="cursor-pointer text-sm text-stone-500 hover:text-stone-700 transition-colors select-none list-none flex items-center gap-1.5">
            <svg class="w-3.5 h-3.5 transition-transform group-open:rotate-90" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5">
          ...
          <div class="mt-3 space-y-3">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div class="space-y-1.5">
                <label class="block text-xs font-medium text-stone-700">Téléphone d'urgence</label>
