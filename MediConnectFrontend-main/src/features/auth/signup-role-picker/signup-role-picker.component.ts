      ...
      <div class="grid grid-cols-2 gap-3 mb-6">
        ...
        <button
          ...
          <div class="text-center">
            ...
            <p class="text-xs text-gray-500 mt-0.5 leading-snug">Gérez vos rendez-vous et votre santé</p>
          </div>
        </button>
        ...
        <button
          ...
          <div class="text-center">
            ...
            <p class="text-xs text-gray-500 mt-0.5 leading-snug">Gérez vos patients et consultations</p>
          </div>
        </button>
      </div>
