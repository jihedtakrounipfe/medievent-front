...
export class NavbarComponent implements OnInit {
  ...
  navLinks = [
    ...
    { label: 'Rendez-vous',  path: '/appointment'  },
  ];
  notifications = [
  ...
  onDocClick(e: MouseEvent): void {
    ...
    if (!t.closest('#plans-btn')) this.isPlansMenuOpen = false;
  }
  togglePlans(): void { this.isPlansMenuOpen = !this.isPlansMenuOpen; }
