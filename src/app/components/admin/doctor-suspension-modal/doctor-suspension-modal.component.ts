...
export interface SuspendPayload { doctor: Doctor; reason: string; }

@Component({
  selector: 'app-doctor-suspension-modal',
  standalone: true,
...
export class DoctorSuspensionModalComponent {
  @Input() doctor: Doctor | null = null;
  @Input() loading = false;
  @Output() confirm = new EventEmitter<SuspendPayload>();
