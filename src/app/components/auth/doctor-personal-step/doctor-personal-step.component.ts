  ...
  template: `
    <div class="rounded-2xl border border-stone-200 bg-white p-4 space-y-4">
      ...
      <form [formGroup]="form" (ngSubmit)="onNext()" novalidate class="space-y-4">
        ...
        <!-- Password -->
        <div formGroupName="passwords" class="space-y-3.5 rounded-2xl border border-stone-100 bg-stone-50 p-4">
          <div>
        ...
        <div class="flex items-center justify-end">
          <button type="submit" class="px-4 py-2 rounded-xl bg-teal-600 text-white hover:bg-teal-700 font-semibold text-sm">
            Suivant →
          </button>
        </div>
      </form>
