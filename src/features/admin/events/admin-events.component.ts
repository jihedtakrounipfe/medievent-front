        ...
        <div class="overflow-x-auto">
          <table class="w-full text-left">
            ...
            <tbody class="divide-y divide-stone-50">
              <tr *ngFor="let ev of events()" class="hover:bg-stone-50/30 transition-colors group">
                <td class="px-8 py-6">
          ...
          <!-- Empty State -->
          <div *ngIf="events().length === 0" class="py-24 text-center">
            ...
            <p class="text-stone-400 text-sm font-bold tracking-tight">Catalogue Vierge</p>
          </div>
        </div>
      </div>
    </div>
